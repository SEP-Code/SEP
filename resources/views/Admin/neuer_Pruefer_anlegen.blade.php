...
@section('content')
    <div class="d-flex justify-content-between pt-3 pb-2 mb-3 border-bottom">
        ...
        <a href="{{ url('/Admin/Pruefer_Uebersicht') }}" class="btn btn-primary pull-right">zurück</a>
    </div>
    <p>Hier können Sie einen neuen Prüfer anlegen.</p>

                        {!! Form::open(['action' => 'UserController@new_Pruefer', 'method' => 'POST']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">
                                    Wählen Sie ein beliebiges Passwort welches der Prüfer später verwendet um sich einzuloggen.
                                </small>
                            </div>
