...
@section('content')
    ...
    @endif
    <p>Bitte geben Sie hier die persönlichen Daten an:</p>
    <br>

    {!! Form::open(['action' => ['UserController@storeNewPruefling', 3], 'method' => 'POST', 'files' => true]) !!}   <!-- übergibt an    Methode Store in PrueflingPersDatenController -->
    @csrf
    ...
    <div class="form-group">
        <label for="exampleFormControlInput1">E-Mail-Adresse</label> <br>
