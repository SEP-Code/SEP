...
class AllResultsPerDisExport_Name implements FromView, WithEvents, ShouldAutoSize
{
    private $disciplines;
    private $erg;
    private $candidates;
    ...
    /**
     * AllResultsPerDisExportBnb constructor.
    ...
    {
        return view('exports.AllResultsByDis_name', [
            'erg' => $this->erg,
